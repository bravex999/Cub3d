...
SRCS_PARSER  = parse_cub_detect.c headers_accept_line.c parse_colors.c parser_headers_color.c parser_headers_utils.c parser_headers_tex.c parser_headers_state.c
SRCS_VALIDATE= 
SRCS_GFX     = 
SRCS_TEX     = 
SRCS_CAMERA  = 
