...
SRCS_PARSER  = parse_cub_detect.c parser_headers_accept.c parse_colors.c parser_headers_color.c parser_headers_utils.c parser_headers_tex.c parser_headers_state.c parse_map_buffer.c parse_cub_ouput.c parse_cub_ouput_2.c parse_cub.c parse_cub_state.c
SRCS_VALIDATE= 
SRCS_GFX     = 
SRCS_TEX     = 
SRCS_CAMERA  = 
